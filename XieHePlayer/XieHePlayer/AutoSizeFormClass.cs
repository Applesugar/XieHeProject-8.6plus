...
namespace XieHePlayer
{
    ...
    class AutoSizeFormClass
    {
        ...
        public void controllInitializeSize(Form mForm)
        {
            // if (ctrl_first == 0)
            {
                //float wScale = (float)Screen.PrimaryScreen.Bounds.Width / 1920;//新旧窗体之间的比例，与最早的旧窗体
                //float hScale = (float)Screen.PrimaryScreen.Bounds.Height / 1080;//.Height;
                //  ctrl_first = 1;
                ...
                {
                    controlRect objCtrl;
                    objCtrl.Left =(int)(c.Left); 
                    objCtrl.Top = (int)(c.Top); 
                    objCtrl.Width = (int)(c.Width);
                    objCtrl.Height = (int)(c.Height);
                    oldCtrl.Add(objCtrl);
                }
            }
